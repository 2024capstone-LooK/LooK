...
class CustomTextFormField extends StatelessWidget {
  ...
  const CustomTextFormField(this.text, {super.key, required this.controller});
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            hintText: "Enter $text",
            hintStyle: const TextStyle(color: Color(0x7FBEBEBE)),
            filled: true,
            fillColor: const Color(0x7FBEBEBE),
